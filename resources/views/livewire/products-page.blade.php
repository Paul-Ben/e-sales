                    ...
                    <div class="w-full pr-2 lg:w-1/4 lg:block">
                        ...
                        <div class="p-4 mb-5 bg-white border border-gray-200 dark:bg-gray-900 dark:border-gray-900">
                            ...
                            <ul>
                                ...
                                <li class="mb-4">
                                    <label for="is_onsale" class="flex items-center dark:text-gray-300">
                                        <input type="checkbox" wire:model.live="is_onsale" id="is_onsale" value="1" class="w-4 h-4 mr-2">
                        ...
                        <div class="p-4 mb-5 bg-white border border-gray-200 dark:bg-gray-900 dark:border-gray-900">
                            ...
                            <div class="w-16 pb-2 mb-6 border-b border-rose-600 dark:border-gray-400"></div>
                            <div>
                                <div class="font-semibold">{{ Number::currency($price_range, 'NGN')}}</div>
                                <input type="range"
                                    wire:model.live="price_range" class="w-full h-1 mb-4 bg-blue-100 rounded appearance-none cursor-pointer"
                                    max="2000000" value="30000" step="1000">
                                <div class="flex justify-between ">
                                    <span class="inline-block text-lg font-bold text-blue-400 ">{{ Number::currency(100, 'NGN') }}</span>
                                    <span class="inline-block text-lg font-bold text-blue-400 ">{{ Number::currency(2000000, 'NGN') }}</span>
                                </div>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="w-full px-3 mb-6 sm:w-1/2 md:w-1/3" wire:key={{ $product->id }}>
                                    <div class="border border-gray-300 dark:border-gray-700">
                                        <div class="relative bg-gray-200">
                                            <a href="{{ route('product-detail', ['slug'=>$product->slug]) }}" class="" wire:navigate> 
                                        ...
                                        <div class="p-3 ">
                                            ...
                                            <p class="text-lg ">
                                                <span
                                                    class="text-green-600 dark:text-green-600">{{ Number::currency($product->price, 'NGN') }}</span>
                                            </p>
                                        </div>
                                        <div
